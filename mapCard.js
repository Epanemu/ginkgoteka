function createCard(name, address, author, date, img_path, id) {
    ...
    var c = new SMap.Card();
    c.getHeader().innerHTML = '<p class="ginkgo_card_name"><b>'+name+'</b></p><img onclick="removeGinkgo('+id+');" class="ginkgo_card_remove" src=images/remove.png /><img onclick="editGinkgo('+id+');" class="ginkgo_card_edit" src=images/edit.png />';
